...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "csbl/P_aeruginosa_recon" ]]; then
    ...
    echo "Tracked build."
    memote run --experimental data/experiments.yml
...
echo "Your new report will be visible at https://csbl.github.io/P_aeruginosa_recon in a moment."
