...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "JenBartell/parecon" ]]; then
...
echo "Your new report will be visible at https://JenBartell.github.io/parecon in a moment."
